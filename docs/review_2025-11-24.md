...
- [x] Enforce per-symbol open-order limits and pending-exposure caps before sending orders; handle partial fills.
- [x] Clamp LLM outputs: bound stops/targets, reject extremes/missing stops, log clamping/validation to dashboard.
- [x] Add EOD/holding-time risk and slippage guard between decision price and current price.
