...
- [ ] Surface prior intent/outcomes: inject a small “memory” block containing open trade plans (id/side/size/stop/target/reason), last N decisions with execution results, and recent risk rejections—kept under a strict byte budget.
